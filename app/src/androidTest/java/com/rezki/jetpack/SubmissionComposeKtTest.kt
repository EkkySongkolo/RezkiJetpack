...
import com.rezki.jetpack.model.DataAnimal
import com.rezki.jetpack.navigation.Screen
import com.rezki.jetpack.ui.theme.SubmissionComposeTheme
...
class SubmissionComposeKtTest {
    ...
    fun navHost_clickItem_navigatesToDetailWithData() {
        ...
        composeTestRule.onNodeWithText(DataAnimal.dummyAnimals[5].name).performClick()
        navController.assertCurrentRouteName(Screen.DetailAnimal.route)
        composeTestRule.onNodeWithText(DataAnimal.dummyAnimals[5].name).assertIsDisplayed()
    }
    ...
    fun favoriteClickInDetailScreen_ShowInFavoriteScreen() {
        composeTestRule.onNodeWithText(DataAnimal.dummyAnimals[0].name).performClick()
        navController.assertCurrentRouteName(Screen.DetailAnimal.route)
        ...
        composeTestRule.onNodeWithStringId(R.string.menu_favorite).performClick()
        navController.assertCurrentRouteName(Screen.Favorite.route)
        composeTestRule.onNodeWithText(DataAnimal.dummyAnimals[0].name).assertIsDisplayed()
    }
